...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static class jquery_autocomplete {
            ...
            public static class lib {
                ...
                public static readonly string thickbox_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/thickbox.min.css") ? Url("thickbox.min.css") : Url("thickbox.css");
            ...
            public static class markitup {
                ...
                public static class skins {
                    ...
                    public static class markdown {
                        ...
                        public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                        public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                        public static readonly string CommentStyle_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/CommentStyle.min.css") ? Url("CommentStyle.min.css") : Url("CommentStyle.css");
                ...
                public static class templates {
                    ...
                    public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                    public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                    public static readonly string preview_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/preview.min.css") ? Url("preview.min.css") : Url("preview.css");
        ...
        public static class openlibrary_wmd_master {
            ...
            public static readonly string wmdCustom_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/wmdCustom.min.css") ? Url("wmdCustom.min.css") : Url("wmdCustom.css");
    ...
    public static class Content {
        ...
        public static readonly string cross_jpg = Url("cross.jpg");
        ...
        public static readonly string james_png = Url("james.png");
