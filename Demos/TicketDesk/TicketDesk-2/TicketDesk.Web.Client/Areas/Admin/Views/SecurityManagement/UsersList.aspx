...
<asp:Content ID="HeadContent" ContentPlaceHolderID="AdminCustomHead" runat="server">
    <script type="text/javascript">
        ...
        function doEmailSearch() {
            ...
            window.location = '/Admin/SecurityManagement/GetUserByEmailAddress/' + emailAddress;
        }
                ...
                <div class="displayContainerInner" style="width: 100%;">
                    <div>
                        ...
                        <div class="activityBody" style="padding: 15px; min-height: 200px;">
                            <div>
                                Look up email address:&nbsp;&nbsp;&nbsp;&nbsp;<input id="EmailAddress" type="text" size="50"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Search" onclick="JavaScript: doEmailSearch();" />
                                <% if ((bool)@ViewBag.NoEmailAddressFound) { %>
                                       <span style='color:#c00'>&nbsp;&nbsp;&nbsp;&nbsp;Couldn't find email address</span>
                                <% } %>
                            </div>
                            <table class="ticketListGrid" cellpadding="0" cellspacing="0" style="width: 100%;margin-top:10px;">
                                <thead>
                                    <tr>
                                        <th>
                                        </th>
