...
namespace TicketDesk.Web.Client.Areas.Admin
{
    public class AdminAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute(
             "SecurityGetUserByEmailAddress",
             "Admin/SecurityManagement/GetUserByEmailAddress/{emailAddress}",
             new { controller = "SecurityManagement", action = "GetUserByEmailAddress" });
