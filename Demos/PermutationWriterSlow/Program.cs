...
{
    /// <summary>
    /// This is version 1 of the file-writing permutation printer
    /// </summary>
    class Program
    {
        /// <summary>
        ...
        static void GenerateReport(PermutationGenerator p)
        {
            ...
            {
                LogApi.LogToFile(tempFile, permutation);
            }
         ...
         * HelloTest has 362880 (non-unique) permutations, which provide enough computation to demonstrate the profiler. 
         */
